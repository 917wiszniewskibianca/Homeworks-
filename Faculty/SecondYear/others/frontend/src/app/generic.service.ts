...
export class GenericService {
  ...
  fetchRooms(category: string, type: string, price: number, hotel: string,currentPage: number ): Observable<Room[]> {
    ...
    //return this.http.get<Room[]>(this.backendUrl + 'Browse/browse-room.php', JSON.stringify(data), { headers: headers });
  }
